          ...
          <div className="relative w-full h-full flex items-center justify-center">
            {(!logoError) ? (
              ...
              <svg viewBox="0 0 100 100" className="w-32 h-32 drop-shadow-md">
                ...
                />
                {/* Central Post */}
                <rect x="47" y="25" width="6" height="50" rx="3" fill="var(--warning)" />
                <circle cx="50" cy="25" r="5" fill="var(--warning)" />
                
                {/* Scale Pans */}
                <motion.path d="M20 40 L15 60 Q20 65 25 60 Z" fill="var(--accent)" />
                <motion.path d="M80 40 L75 60 Q80 65 85 60 Z" fill="var(--accent)" />
                
                {/* SN Badge inside SVG */}
                <circle cx="85" cy="20" r="10" fill="var(--warning)" stroke="white" strokeWidth="2" />
